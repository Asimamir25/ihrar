...
import {AUTH_NAVIGATION_SCREEN} from '../../navigation/NavigationScreen';
    ...
    <ScrollView>
      <SafeAreaView style={{flex: 1}}>
        <View style={{flex: 1, backgroundColor: '#f3f6ff'}}>
          ...
          <View style={{paddingHorizontal: 20, gap: 20, paddingVertical: 13}}>
            <Text
              style={{
                // textAlign: 'center',
                paddingTop: 20,
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate(AUTH_STACK_SCREEN.REGISTER);
            }}>
            <Text
              style={{
                textAlign: 'center',
